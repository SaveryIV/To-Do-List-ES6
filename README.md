...
<div align="center">
  <h3><b>To-Do List, Using ES6 modules and libraries</b></h3>
</div>
...
**[ToDo List - ES6]** is the second project in the 2nd week on the second module. Here we are practicing the use of libraries, loaders, plugins and sever Webpack. Also to the modules structure for make a modular clean code.
